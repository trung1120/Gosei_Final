...
{
    public abstract class FinalProjectWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static FinalProjectWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(FinalProjectWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<FinalProjectDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<FinalProjectDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<FinalProjectDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<FinalProjectDbContext, Task<T>> func)
        {
            T result;
